...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstMidName,HireData,LastName,OfficeAssignment")] Instructor instructor, string[] selectedCourses)
        {
        ...
        public async Task<IActionResult> Edit(int? id, string[] selectedCourses)
        {
            ...
            if (await TryUpdateModelAsync<Instructor>(
                instructorToUpdate,
                "",
                i => i.FirstMidName, i => i.LastName, i => i.HireDate, i => i.OfficeAssignment)) // overposting whitelist like..
            {
                ...
                catch (DbUpdateException /* ex */)
                {
                    ...
                    ModelState.AddModelError("", _saveErrorMessage);
                }
                return RedirectToAction("Index");
            }
